...
This module helps install [OpenShift Origin](http://openshift.github.io)
...
[github repository](https://github.com/openshift/puppet-openshift_origin).

1. Download the [Zip file from github](https://github.com/openshift/puppet-openshift_origin/archive/master.zip)
